...
const TABLE_HEAD = [
  ...
  { id: 'createdAt', label: 'HSN CODE', align: 'left', width: 250 },
  { id: 'inventoryType', label: 'CGST', align: 'left', width: 180 },
  { id: 'price', label: 'SGST', align: 'center', width: 180  },
  { id: '', label: 'IGST', align:'center' },
  { id: '' },
  { id: '' },
  { id: '' },
];
...
const Group_Name = [
  { value: 'group_1', label: 'Ten80 Company' },
  { value: 'group_2', label: 'Twenly' },
  { value: 'group_3', label: 'Thirsty Adams' },
];
...
export default function EcommerceProductListPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Item Master: Item Category List | Minimal UI</title>
      </Helmet>

      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          heading="Item Category Listing"
          links={[
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.itemMaster.item}
              variant="contained"
            >
              Create New Item
            </Button>
