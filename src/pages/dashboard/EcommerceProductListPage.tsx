...
const TABLE_HEAD = [
  ...
  { id: 'createdAt', label: 'GSTIN', align: 'left', width: 180 },
  { id: 'inventoryType', label: 'Group Name', align: 'left', width: 180 },
  { id: 'price', label: 'Due Amount', align: 'left', width: 180 },
  { id: '' },
  { id: '' },
  { id: '' },
  { id: '' },
...
export default function EcommerceProductListPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Ecommerce: Account List | Minimal UI</title>
      </Helmet>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          action={
            <Button component={RouterLink} to={PATH_DASHBOARD.eCommerce.new} variant="contained">
              Create New Account
            </Button>
          }
        />
