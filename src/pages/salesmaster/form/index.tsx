...
//
import SalesMasterEditDetails from './SalesMasterEditDetails';
import SalesMasterEditAddress from './SalesMasterEditAddress';
import SalesMasterVoucherDate from './SalesMasterVoucherDate';
...
export default function InvoiceNewEditForm({ isEdit, currentInvoice }: Props) {
  ...
  return (
    <FormProvider methods={methods}>
      <Card>
        <SalesMasterEditAddress />

        <SalesMasterVoucherDate />

        <SalesMasterEditDetails />
      </Card>
