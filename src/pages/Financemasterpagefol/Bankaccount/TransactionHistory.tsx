    ...
    >
      ...
      <TableContainer component={Paper}>
        <Table size="small" aria-label="a dense table">
          <TableHead>
            <TableRow>
              <TableCell align="left" sx={{ paddingRight: '16px' }}>
                TXN No.
              </TableCell>
              <TableCell align="left" sx={{ paddingRight: '16px' }}>
                Bill Date
            ...
            {rowsToShow.map((row, index) => (
              <React.Fragment key={index}>
                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  <TableCell component="th" scope="row" align="left" sx={{ paddingRight: '16px' }}>
                    {row.name}
                  </TableCell>
                  <TableCell align="left" sx={{ whiteSpace: 'nowrap', paddingRight: '16px' }}>
                    {row.bill1}
                  </TableCell>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell align="left" />
              <TableCell align="left" />
              <TableCell align="left">$33.36</TableCell>
              <TableCell align="left">$66.67</TableCell>
              <TableCell align="left" />
            </TableRow>
          </TableBody>
        </Table>
