...
export const ItemMasterCreate = Loadable(
  lazy(() => import('../pages/dashboard/ItemMasterCreate'))
);
export const ItemMasterWarehouse = Loadable(
  lazy(() => import('../pages/dashboard/ItemMasterWarehouse'))
)
export const ItemMasterItem = Loadable(
  lazy(() => import('../pages/dashboard/ItemMasterItem'))
)
export const ItemCateoryList = Loadable(
  lazy(() => import('../pages/dashboard/ItemCategoryList'))
)
export const ItemMasterGodown = Loadable(
  lazy(() => import('../pages/dashboard/ItemMasterGodown'))
)
...
// Purchase Master Invoice
export const PurchaseMasterInvoiceCreate = Loadable(
  lazy(() => import('../pages/purchasemaster/PurchaseMasterInvoiceCreate'))
);

// Sales Master Invoice
export const SalesMasterInvoiceCreate = Loadable(
  lazy(() => import('../pages/salesmaster/SalesMasterInvoiceCreate'))
);
// finance Master
export const FinaceMasterPage  = Loadable(
  lazy(() => import('../pages/Financemasterpagefol/FinaceMasterPage'))
);
export const BankAccountMaster  = Loadable(
  lazy(() => import('../pages/Financemasterpagefol/BankAccountMaster'))
);
export const CashAccountMaster  = Loadable(
  lazy(() => import('../pages/Financemasterpagefol/CashAccountMaster'))
);
export const JounralVoucherMaster  = Loadable(
  lazy(() => import('../pages/Financemasterpagefol/JounralVoucherMaster'))
);