...
import {
  ...
  DemoUploadPage,
  DemoMarkdownPage,
  PurchaseMasterInvoiceCreate,
  SalesMasterInvoiceCreate,
  FinaceMasterPage,
  BankAccountMaster,
  CashAccountMaster,
    ...
    // Dashboard
    {
      ...
      children: [
        ...
        },
        {
          path: 'item-master',
          children: [
            { element: <Navigate to="/dashboard/item-category/shop" replace />, index: true },
            // { path: 'shop', element: <EcommerceShopPage /> },
            // { path: 'product/:name', element: <EcommerceProductDetailsPage /> },
            { path: 'item', element: <ItemMasterItem /> },
            { path: 'product/new', element: <ItemMasterCreate /> },
            { path: 'godown', element: <ItemMasterGodown /> },
            { path: 'warehouse', element: <ItemMasterWarehouse /> },
            { path: 'list', element: <ItemCateoryList /> },
          ],
        },
        {
          path: 'purchase-master',
          children: [{ path: 'purchase', element: <PurchaseMasterInvoiceCreate /> }],
        },
        {
          path: 'sales-master',
          children: [{ path: 'sales', element: <SalesMasterInvoiceCreate /> }],
        },
        {
          path: 'finance-master',
          children: [
            {
              element: <Navigate to="/dashboard/finance-master/paymententry" replace />,
              index: true,
            },
            { path: 'paymententry', element: <FinaceMasterPage /> },
            { path: 'bankaccount', element: <BankAccountMaster /> },
            { path: 'cashaccount', element: <CashAccountMaster /> },
            { path: 'journalvoucher', element: <JounralVoucherMaster /> },
          ],
        },
        {
          path: 'user',
